...
The tumor-overlay route was prepared for multiple tumor sizes and locations. The tested size settings used small, medium and large spherical overlays with radii of $3~\mathrm{mm}$, $6~\mathrm{mm}$ and $10~\mathrm{mm}$, respectively. 

The reported solved tumor cases focused on a medium upper-outer tumor, because the upper-outer breast quadrant is frequently reported as the most common tumor location \cite{Rummel2015}. Additional build-level placements were generated in central, subareolar, posterior and surface-proximal positions to test whether the analytic tumor mask could be positioned consistently across different anatomical regions.
