...
public class default_comsol_comsol_verify {
  ...
  private static String chooseModelPath() {
    String resultPath = "C:/Users/20223231/ews_fem_clean/runs/comsol_testcases/output/solve/default_comsol_result.mph";
    if (new File(resultPath).exists()) {
      return resultPath;
    }
    String generatedPath = "C:/Users/20223231/ews_fem_clean/runs/comsol_testcases/output/build/default_comsol_generated.mph";
    if (new File(generatedPath).exists()) {
      return generatedPath;
    }
    String fallbackPath = "C:/Users/20223231/ews_fem_clean/runs/comsol_testcases/output/build/default_comsol_generated_Model.mph";
  ...
  public static Model run() throws Exception {
    ...
    json.append("{\n");
    json.append("  \"case_name\": \"default_comsol\",\n");
    json.append("  \"loaded_model_path\": \"").append(modelPath.replace("\\", "/")).append("\",\n");
    json.append("  \"loaded_model_role\": \"").append(modelPath.endsWith("_result.mph") ? "solve_result" : "generated_build").append("\",\n");
    json.append("  \"physics\": {\n");
