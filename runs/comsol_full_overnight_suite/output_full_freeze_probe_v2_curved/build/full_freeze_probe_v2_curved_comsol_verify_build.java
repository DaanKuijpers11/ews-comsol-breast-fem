...
public class full_freeze_probe_v2_curved_comsol_verify_build {
  ...
  private static String chooseModelPath() {
    String candidate1 = "C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_freeze_probe_v2_curved/build/full_freeze_probe_v2_curved_generated.mph";
    if (new File(candidate1).exists()) {
      return candidate1;
    }
    String candidate2 = "C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_freeze_probe_v2_curved/build/full_freeze_probe_v2_curved_generated_Model.mph";
    if (new File(candidate2).exists()) {
      return candidate2;
    }
    return "C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_freeze_probe_v2_curved/build/full_freeze_probe_v2_curved_generated.mph";
  }
