...
public class full_baseline_reference_simple_gland_static_baseline_comsol_verify_solve {
  ...
  private static String chooseModelPath() {
    String candidate1 = "C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_baseline_reference_simple_gland_static_baseline/solve/full_baseline_reference_simple_gland_static_baseline_result.mph";
    if (new File(candidate1).exists()) {
      return candidate1;
    }
    String candidate2 = "C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_baseline_reference_simple_gland_static_baseline/build/full_baseline_reference_simple_gland_static_baseline_generated.mph";
    if (new File(candidate2).exists()) {
      return candidate2;
    }
    String candidate3 = "C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_baseline_reference_simple_gland_static_baseline/build/full_baseline_reference_simple_gland_static_baseline_generated_Model.mph";
    if (new File(candidate3).exists()) {
      return candidate3;
    }
    return "C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_baseline_reference_simple_gland_static_baseline/solve/full_baseline_reference_simple_gland_static_baseline_result.mph";
  }
  ...
  public static Model run() throws Exception {
    ...
    json.append("{\n");
    json.append("  \"case_name\": \"full_baseline_reference_simple_gland_static_baseline\",\n");
