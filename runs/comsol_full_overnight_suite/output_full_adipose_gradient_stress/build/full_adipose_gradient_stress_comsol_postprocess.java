...
public class full_adipose_gradient_stress_comsol_postprocess {
  ...
  public static Model run() throws Exception {
    ...
    Model model = ModelUtil.load("PostModel", "C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_adipose_gradient_stress/solve/full_adipose_gradient_stress_result.mph");
    ...
    String json = ""
      + "{\n"
      + "  \"case_name\": \"full_adipose_gradient_stress\",\n"
      + "  \"source\": \"COMSOL\",\n"
