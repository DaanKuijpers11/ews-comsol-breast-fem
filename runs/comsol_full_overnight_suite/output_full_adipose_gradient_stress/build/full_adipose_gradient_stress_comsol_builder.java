...
public class full_adipose_gradient_stress_comsol_builder {
  public static Model run() {
    ModelUtil.initStandalone(true);
    Model model = ModelUtil.create("Model");
    model.label("full_adipose_gradient_stress_generated.mph");
    model.modelPath("C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_adipose_gradient_stress/build");
    ...
    model.param().set("chest_curve_depth", "0.0010000000[m]");
    model.param().set("chest_curve_radius", "2.4505000000[m]");
    model.param().set("chest_curve_center_y", "-2.4495000000[m]");
    model.param().set("mesh_density_hint", "160.0");
    ...
    // - Build plan JSON: C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_adipose_gradient_stress/prepare/full_adipose_gradient_stress_comsol_build_plan.json
    // - Selection hints JSON: C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_adipose_gradient_stress/build/full_adipose_gradient_stress_comsol_selection_hints.json
  ...
  public static void main(String[] args) throws Exception {
    Model model = run();
    model.save("C:/Users/20223231/ews_fem_clean/runs/comsol_full_overnight_suite/output_full_adipose_gradient_stress/build/full_adipose_gradient_stress_generated.mph");
